...
<head> 
    ...
    <style>
        ...
        em{color:red}
        .hello{width:250px;height:100%;padding:10px; margin:50px auto 0; border:1px solid #ddd;overflow:hidden;}
        .link{float:right;}
    </style>
</head>
<body>
    <div class="hello">
        <div align="center">
            <h1><a target="_blank" href="<?=$url?>"><img src="auth_icon.png" style="vertical-align: middle;"/></a></h1>
        </div>
        <h2><em>^_^</em>&nbsp;您可以将以下权限授权给我们</h2>
        <div>
            <ul>
                <li>网页服务权限</li>
                <li>群发与通知权限</li>
