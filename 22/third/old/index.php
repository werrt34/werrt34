...
class wechatCallbackapiTest
{
    ...
    {
        $signature  = "d350c02cac7de26d711c34dbd324e4302d2d03f6";   //$_GET['signature'];
		$timestamp  = "1465224690";     //$_GET['timestamp'];
		$nonce = "112361693";           //$_GET['nonce'];
        $encrypt_type = "aes";          //$_GET['encrypt_type'];
		$msg_signature  = "d5662569ff8a5dd92fe6b419e361807c52fa0f18";   //$_GET['msg_signature'];
        $postStr = "<xml>
    <AppId><![CDATA[wx2ae3853dda623211]]></AppId>
    <Encrypt><![CDATA[]]></Encrypt>
